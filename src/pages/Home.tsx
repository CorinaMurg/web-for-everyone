            ...
            <section aria-labelledby="lets-make-it-accessible" className={styles['hero-article']}>
                ...
                <div className={styles['svg-container']}>
                    <div className="svg-container">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" viewBox="0 0 640 512" >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="45" height="40" viewBox="0 0 576 512" >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" viewBox="0 0 640 512" stroke="1">
