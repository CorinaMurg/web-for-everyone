            ...
            <section className={styles['hero']}> 
                <div className={styles['hero--design']}>
                    ...
                    <p>
                        ...
                        <span className="pink-bg-white-text-round">all</span> visitors, including those with disabilities? 
                    </p>
                ...
                <div className={styles['hero--text']}>
                    ...
                    <div className={styles['hero--text--right']}>
                        <div>
                            ...
                            <p>
                                Use our checklist of common accessibility bugs to make sure they are
                                not hiding in your portfolio site. If they are, we'll help you squash them!
                            </p>
                        </div>
