            ...
            <section className={styles['hero--text']}>
                <div className={styles['hero--text--left']}> 
                    ...
                    >   
                        ...
                        <svg aria-hidden="true" id="bug" width="28" height="28" viewBox="0 0 512 512">
                ...
                <div className={styles['hero--text--right']}>
                    ...
                    >   
                        ...
                        <svg aria-hidden="true" id="bug" width="28" height="28" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg" >
