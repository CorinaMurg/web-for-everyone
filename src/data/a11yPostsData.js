...
export const a11yPostsData = [
    ...
    },
    {
        ...
        "description": `While rem units are often championed for their scalability, particularly for 
            ...
            and spacing. Read Ashlee M Boyer's post on how using px units for spacing can 
    ...
    },
    {
        ...
        "hrefAriaLabel": "Link to the UW News article about the accessibility potential of AI tools like ChatGPT and Midjourney for people with disabilities."
    },
    {
        "label": "other",
        ...
        covers best practices for designing a navigation system that's user-friendly and accessible. A (very long) must read!`,
