...
export default function A11yBanner() {
    return (
        ...
        <div className={`${styles['rectangle']} ${styles['rectangle-1']}`}>         
            <svg aria-hidden="true" width="40" height="40" viewBox="0 0 512 512" >
        ...
        <div className={`${styles['rectangle']} ${styles['rectangle-4']}`}> 
            <svg aria-hidden="true" width="43.75" height="35" viewBox="0 0 640 512" >
        ...
        <div className={`${styles['rectangle']} ${styles['rectangle-5']}`}> 
            <svg aria-hidden="true" width="35" height="40" viewBox="0 0 448 512">
